...
import { ArrowDown, ArrowUpRight, FileDown, Mail, MapPin, MessageCircle } from 'lucide-react';
      ...
      <main>
        <section className="hero shell" id="home">
          <div className="hero-copy">
            ...
            <h1 aria-label="Asim Aslah"><span>ASIM</span><em>ASLAH</em></h1>
            ...
            <div className="hero-actions hero-actions-primary">
              <SectionAnchor className="primary-button" sectionId="projects" data-sound="primary">View projects <ArrowDown aria-hidden="true" /></SectionAnchor>
              <SectionAnchor className="secondary-button" sectionId="contact" data-sound="primary">Contact me <ArrowUpRight aria-hidden="true" /></SectionAnchor>
            </div>
        ...
        <section className="section shell" id="skills">
          <Reveal>
            <SectionHeading eyebrow="Technical skills / 02" title="A focused, full-stack toolkit." description="The technologies I use to take AI ideas from model experiments to dependable interfaces." />
          </Reveal>
        ...
        <section className="section shell experience-section" id="experience" aria-labelledby="experience-heading">
          <Reveal>
            <SectionHeading eyebrow="Experience / 03" title="Industry experience." description="Verified product work with a real software team." />
          </Reveal>
        ...
        <section className="section shell" id="about">
          <Reveal>
            <SectionHeading eyebrow="About / 04" title="Engineering with a product mindset." />
          </Reveal>
